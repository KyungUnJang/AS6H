...
uint16_t ADC10dma_Value[10];	/* Battery Voltage */
uint16_t ADC11dma_Value[10];	/* RFR �ӵ� ���� Voltage */
uint8_t ADC10_Cnt = 0;
...
uint8_t WLEmptyCnt1 = 0;			/* ���� Empty Count 4�� */
uint8_t WLEmptyCnt2 = 0;			/* ��ü Empty Count 4�� */
uint8_t WLFullCnt1 = 0;			/* ���� Full Count  2�� */
uint8_t WLFullCnt2 = 0;			/* ��ü Full Count  2�� */
...
uint16_t canDTIntime = 0;	/* �� Timer �� 0 �� �ǰ�, �������� ���̸�, Stop �Ѵ�. nck-1222 */

uint8_t crash_Cnt = 0;		/* 220122 */
uint8_t LKAUTOSeq = 0;
